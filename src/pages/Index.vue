  ...
  <Layout>
    <section class="text-black bg-black relative">
      <div class="pt-24 container mx-auto flex justify-between">
        ...
        <g-image
          src="~/showcase.png"
          width="600px"
          style=" margin-bottom: -100px; box-shadow: 40px 40px 40px rgba(0, 0, 0, 0.25);"
        ></g-image>
      </div>
    </section>
    ...
    <section class="py-32 container mx-auto">
      ...
      <div class="flex justify-between mt-16">
        <div
          v-for="why in theWhys"
          :key="why.tag"
          class="bg-black p-6 text-white max-w-sm relative overflow-hidden"
        >
          <div
            class="absolute h-64 w-64 bg-yellow-brand-15 top-0 right-0 -mr-32 -mt-32 rounded-full"
          >
          ...
          <div class="flex flex-col justify-between h-full">
            <div>
              <span
                class="inline-block bg-indigo-700-25 text-indigo-400 p-4 uppercase tracking-wide"
              >{{ why.tag }}</span>
      ...
      <div class="container mx-auto">
        ...
        <div class="flex items-start justify-between mt-16">
          ...
          <div class="max-w-lg">
            ...
            <span
              class="inline-block bg-indigo-700-25 text-indigo-400 p-4 uppercase tracking-wide mr-4"
            ...
            <p
              class="mt-8"
            >Progic is the new startup dyfying the standards of creating knock off websites and webaplications. It focuses on creating premium quality websites and applications that aim to solve specific business cases.</p>

            <p
              class="mt-4"
            >We designed progic.co from scratch to showcase our design and development skills, now reputable brands such as yours are browsing the site and enjoying the view.</p>

            <div class="max-w-sm border-t-4 border-indigo-700 bg-white text-black p-4 mt-8">
              <p>Not to toot our own horn, I think the team did an incredible job at developing this site. I would definatly recommend all forward thinking companies to get work with us.</p>
            ...
            <button
              class="bg-yellow-brand text-black py-4 px-8 rounded font-medium mt-8 max-w-sm w-full"
            >Get in touch</button>
          </div>
        </div>
        ...
        <div class="flex items-start justify-between mt-32">
          ...
          <div class="max-w-lg order-0">
            ...
            <p
              class="mt-8"
            >Your company is the industry standard but it is lagging behind because you either have no website or the one you have is outdated and gets abandoned by customers everytime they visit.</p>

            <p
              class="mt-4"
            >You’d be realising more revenue if only your website truly showed off the value you provide to your customers.</p>

            <p
              class="mt-4"
            >But we can help fix that! One day when we satify you you'll give us a testimonial along these lines 👇🏽👇🏽👇🏽.</p>

            <div class="max-w-sm border-t-4 border-indigo-700 bg-white text-black p-4 mt-8">
              <p>I trusted my gut and went with Progic. I was never dissapointed. shout out to their creative team. They are the best!!</p>
    ...
    <section
      id="apply-for-work"
      class="container mx-auto flex items-center justify-center pt-32 text-base"
      style="margin-top: -15%"
    >
